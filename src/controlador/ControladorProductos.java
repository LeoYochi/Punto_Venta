...
public class ControladorProductos {
    ...
    private Panel_Producto vista;
    
    //Constructor

    public ControladorProductos() {
        //Crear objetos modelo y vista
        this.vista = new Panel_Producto();
    ...
    public Panel_Producto getVista() {
        return vista;
    }

    public void setVista(Panel_Producto vista) {
        this.vista = vista;
    }
    ...
    private void registrarProducto() {
        ...
        if (validarCajasTextoRol()) {
            ...
            this.modelo.setPrecio(Integer.parseInt(this.vista.txtPrecio.getText()));
            this.modelo.setCantidad(Integer.parseInt(this.vista.txtCantidad.getText()));
